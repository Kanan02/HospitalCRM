...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240226081415_initials")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Module", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8304ef6e-0a66-47ce-ac93-f0337c3c8c06"),
                            CreatedAt = new DateTime(2024, 2, 26, 12, 14, 15, 337, DateTimeKind.Local).AddTicks(2367),
                            Description = "Module for queue managing.",
                            Name = "Queue Module"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Security.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("af86f8e5-360c-4ac5-9fb4-8d75b69c5942"),
                            CreatedAt = new DateTime(2024, 2, 26, 12, 14, 15, 337, DateTimeKind.Local).AddTicks(2146),
                            Name = "superadmin"
                        },
                        new
                        {
                            Id = new Guid("e77f1acd-532c-476d-9839-aaa68552a31c"),
                            CreatedAt = new DateTime(2024, 2, 26, 12, 14, 15, 337, DateTimeKind.Local).AddTicks(2160),
                            Name = "admin"
                        },
                        new
                        {
                            Id = new Guid("ef305cc0-6b0f-4871-9e63-37eb673f3021"),
                            CreatedAt = new DateTime(2024, 2, 26, 12, 14, 15, 337, DateTimeKind.Local).AddTicks(2171),
                            Name = "user"
                        },
                        new
                        {
                            Id = new Guid("ee4bfb61-2322-479f-ac8d-122574e53fbe"),
                            CreatedAt = new DateTime(2024, 2, 26, 12, 14, 15, 337, DateTimeKind.Local).AddTicks(2174),
                            Name = "doctor"
                        });
                });
            ...
            modelBuilder.Entity("UserProfileClinic", b =>
                {
                    ...
                    b.ToTable("user_profile_clinics", (string)null);
                });
