...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240327125241_added_message_template_table")]
    partial class added_message_template_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MessageTemplateClinic", b =>
                {
                    b.Property<Guid>("clinic_id")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("message_template_id")
                        .HasColumnType("char(36)");

                    b.HasKey("clinic_id", "message_template_id");

                    b.HasIndex("message_template_id");

                    b.ToTable("message_template_clinics", (string)null);
                });
            ...
            modelBuilder.Entity("MessageTemplateClinic", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.MessageTemplate", null)
                        .WithMany()
                        .HasForeignKey("message_template_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
